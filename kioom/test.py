...
if __name__ == "__main__":
    ...
    for i in range(10):
        ...
        kiwoom.set_input_value("종목코드", list_str[i])
    ...
    sql = """insert into BASE_DATA(STOCK_CODE,STOCK_NAME,TOTAL,PER,EPS,ROE,PBR,BPS,SALES,BENEFIT,AFTERBENEFIT,CURRENT_PRICE)
